export const TECHNICIAN_TEST_TEXT = {
  activeAccess: "permite el acceso cuando cliente, taller y suscripción están activos",
  suspendedAccess: "rechaza el acceso cuando el taller está suspendido",
  ownWorkshop: "la identidad del cliente solo reconoce su propio taller",
  foreignWorkshop: "la identidad del cliente rechaza un taller de otro tenant",
