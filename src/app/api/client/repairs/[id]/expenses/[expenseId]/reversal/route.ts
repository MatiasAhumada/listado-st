...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string; expenseId: string }> }) {
  try {
    ...
    return NextResponse.json(await RepairService.reverseExpense(identity, id, expenseId, payload), {
